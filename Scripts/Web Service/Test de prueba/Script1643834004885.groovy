...
emailContent = new getEmailContent()

String link2 = CustomKeywords.'gmail_Connection.ConfirmEmail.fetchEmailVerifyURL'(GlobalVariable.G_Gmail_Test_Account,  GlobalVariable.G_Gmail_Test_Account_Pass, GlobalVariable.G_Applicant_Email)

System.out.println(link2)

WebUI.navigateToUrl(link2)
